...
class ProfileHeader: UICollectionReusableView {
    ...
    override init(frame: CGRect) {
        ...
        let follwStack = UIStackView(arrangedSubviews: [followingLabel, followersLabel])
        follwStack.axis = .horizontal
        follwStack.spacing = 8
        follwStack.distribution = .fillEqually
        
        addSubview(follwStack)
        follwStack.anchor(top: userDetailStack.bottomAnchor, left: leftAnchor, paddingTop: 8, paddingLeft: 12)
